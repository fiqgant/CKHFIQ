...
def drawALL(img, buttonList):
    ...
    for button in buttonList:
        x, y = button.pos
        w, h = button.size
        cvfiq.cornerRect(imgNew, (x, y, w, h), 20, rt=0)
        cv2.rectangle(imgNew, button.pos, (x + w, y + h), (25,25,112), cv2.FILLED)
...
while True:
    ...
    cv2.rectangle(img, (50, 710), (700, 610), (25,25,112), cv2.FILLED)
